...
// shapeDraw.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CshapeDrawApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CshapeDrawApp

CshapeDrawApp::CshapeDrawApp()
{
...
// Единственный объект CshapeDrawApp

CshapeDrawApp theApp;


// Инициализация CshapeDrawApp

BOOL CshapeDrawApp::InitInstance()
{
